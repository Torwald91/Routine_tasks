...
def clean_system():
    ...
    script_path = f'sudo /home/{username}/.Scripts/Clean_script'
    ...
    if snap_clear_choice == 'y':
        script_snp_path = f'sudo /home/{username}/.Scripts/snap_clean'
...
def clear_logs():
    ...
    if lgpros.lower() == 'y':
        ...
        if 1 <= time_cl <= 4:
            ...
            os.system(f'journalctl --vacuum-time={time_value}{time_units[time_cl-1][0]}')
            print ('Usable space:\n')
            os.system('journalctl --disk-usage\n')
            time.sleep(2)
        else:
